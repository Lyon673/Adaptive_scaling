...
def visualize_optimal_parameters(optimal_data, output_path="Optimal_Parameters_Distribution.png"):
    """
    绘制贝叶斯优化最优参数组合的差异可视化图（平滑的Z-score平行坐标图）。
    """
    # ==========================================
    # 1. 学术级样式设置
    # ==========================================
    ...
    # 强制固定列的物理顺序，严格对应公式: K_g, C_base, K_p, alpha_1, beta_1, alpha_2, beta_2, alpha_3, gamma
    ...
    # 统一提取 LaTeX 格式的标签 (严格对应 ordered_params 的顺序)
    latex_labels = [
        r'$K_g$',
        r'$C_{\mathrm{base}}$',
        r'$K_p$',
    ...
    # ---------------------------------------------------------
    # 绘制 Z-score 平行坐标图 (Smooth Z-score Parallel Coordinates)
    # ---------------------------------------------------------
    ...
    # 装饰平行坐标图
    ax_parallel.set_title('Smooth Parallel Coordinates of Z-score Hyperparameters', fontweight='bold', pad=15)
...
if __name__ == "__main__":
    ...
    optimal_params_mock = {
        ...
        3: {"K_g": 10.808192797812778, "C_base": 10.978811801615047, "K_p": 1.18, "alpha_1": 2.2949116589467016, "beta_1": 1.55, "alpha_2": 4.1983396644297235, "beta_2": 2.42, "alpha_3": 3.923855971837864, "gamma": 4.553815277583111},
        ...
        5: {"K_g": 6.112117725918013, "C_base": 11.729176675963613, "K_p": 0.99, "alpha_1": 3.4578946545631365, "beta_1": 1.76, "alpha_2": 4.202443320194236, "beta_2": 2.28, "alpha_3": 3.952259315416258, "gamma": 4.329001414529318},
        6: {"K_g": 8.0, "C_base": 10.740768116529518, "K_p": 1.12, "alpha_1": 3.9591029250180663, "beta_1": 2.45, "alpha_2": 3.7504741683031346, "beta_2": 1.51, "alpha_3": 4.0, "gamma": 1.8608319789973347},
