...
class DataCollector:
	...
	def maincb(self, Lpsm, Rpsm, Lmtm, Rmtm, camera_depthdata, cameraR, cameraFrame):
		...
		if self.collecting:
			...
			print(f"{'Gaze Point reconstruction':<25}: [{transform_world_to_camera(gazepoint_position3, cameraR.pose, cameraFrame.pose)[0]:.3f}, {transform_world_to_camera(gazepoint_position3, cameraR.pose, cameraFrame.pose)[1]:.3f}]")
			print("=" * 50)
			print("\n")
